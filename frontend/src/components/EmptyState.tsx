...
export default function EmptyState({ type, action }) {
  const config = {
    groups: { icon: Users, title: 'Marketplace not ready yet', message: 'Verify your campus account to unlock buy and sell.', buttonText: 'Open Marketplace', buttonAction: action },
    ...
    posts: { icon: FileText, title: 'No announcements yet', message: 'Share the first campus update.', buttonText: 'Create Announcement', buttonAction: action },
  };
