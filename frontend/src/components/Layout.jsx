...
const getNotificationActorId = (notification = {}) => (
...
const getMessageNotificationThreadKey = (notification = {}) => {
...
export default function Layout({ children }) {
  ...
  const mobileTabStyle = { '--mobile-tab-count': mobileBottomItems.length };
