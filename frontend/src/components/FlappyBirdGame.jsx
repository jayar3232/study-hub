  ...
  return (
    <section className="overflow-hidden rounded-3xl border border-sky-900/60 bg-sky-950 text-white shadow-2xl shadow-sky-500/10">
        ...
        <div className="relative flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-1 max-w-xl text-sm leading-6 text-white/65">Tap to fly through study gates. The longer you survive, the higher your Game Hub score.</p>
            </div>
          </div>
      ...
      <GameOverModal
        ...
        title="Flight ended"
        score={score}
        detail="Try again to climb the Game Hub leaderboard."
        saving={saving}
        saved={saved}
        onRetry={resetGame}
        onExit={onExit}
